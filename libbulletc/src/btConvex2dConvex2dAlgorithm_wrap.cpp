...
btConvex2dConvex2dAlgorithm::CreateFunc* btConvex2dConvex2dAlgorithm_CreateFunc_new(
...
int btConvex2dConvex2dAlgorithm_CreateFunc_getMinimumPointsPerturbationThreshold(
	btConvex2dConvex2dAlgorithm::CreateFunc* obj)
{
...
void btConvex2dConvex2dAlgorithm_CreateFunc_setMinimumPointsPerturbationThreshold(
	btConvex2dConvex2dAlgorithm::CreateFunc* obj, int value)
{
	obj->m_minimumPointsPerturbationThreshold = value;
}

void btConvex2dConvex2dAlgorithm_CreateFunc_setNumPerturbationIterations(btConvex2dConvex2dAlgorithm::CreateFunc* obj,
	int value)
{
	obj->m_numPerturbationIterations = value;
}

void btConvex2dConvex2dAlgorithm_CreateFunc_setPdSolver(btConvex2dConvex2dAlgorithm::CreateFunc* obj,
	btConvexPenetrationDepthSolver* value)
{
	obj->m_pdSolver = value;
}

void btConvex2dConvex2dAlgorithm_CreateFunc_setSimplexSolver(btConvex2dConvex2dAlgorithm::CreateFunc* obj,

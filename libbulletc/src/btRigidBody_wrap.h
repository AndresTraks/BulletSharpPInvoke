...
extern "C"
{
	...
	EXPORT void btRigidBody_getAngularFactor(btRigidBody* obj, btVector3* angFac);
	EXPORT btScalar btRigidBody_getAngularSleepingThreshold(btRigidBody* obj);
	EXPORT void btRigidBody_getAngularVelocity(btRigidBody* obj, btVector3* ang_vel);
	...
	EXPORT void btRigidBody_getCenterOfMassTransform(btRigidBody* obj, btTransform* xform);
	...
	EXPORT void btRigidBody_getGravity(btRigidBody* obj, btVector3* acceleration);
	EXPORT void btRigidBody_getInvInertiaDiagLocal(btRigidBody* obj, btVector3* diagInvInertia);
	...
	EXPORT void btRigidBody_getLinearFactor(btRigidBody* obj, btVector3* linearFactor);
	EXPORT btScalar btRigidBody_getLinearSleepingThreshold(btRigidBody* obj);
	EXPORT void btRigidBody_getLinearVelocity(btRigidBody* obj, btVector3* lin_vel);

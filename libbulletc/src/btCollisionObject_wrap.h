...
extern "C"
{
	...
	EXPORT void btCollisionObject_getInterpolationAngularVelocity(btCollisionObject* obj, btVector3* angvel);
	EXPORT void btCollisionObject_getInterpolationLinearVelocity(btCollisionObject* obj, btVector3* linvel);
	EXPORT void btCollisionObject_getInterpolationWorldTransform(btCollisionObject* obj, btTransform* trans);
	...
	EXPORT void btCollisionObject_getWorldTransform(btCollisionObject* obj, btTransform* worldTrans);

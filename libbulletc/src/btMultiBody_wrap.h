...
extern "C"
{
	...
	EXPORT void btMultiBody_computeAccelerationsArticulatedBodyAlgorithmMultiDof(btMultiBody* obj, btScalar dt, btAlignedObjectArray<float>* scratch_r, btAlignedObjectArray_btVector3* scratch_v, btAlignedObjectArray_btMatrix3x3* scratch_m);
	EXPORT void btMultiBody_computeAccelerationsArticulatedBodyAlgorithmMultiDof2(btMultiBody* obj, btScalar dt, btAlignedObjectArray<float>* scratch_r, btAlignedObjectArray_btVector3* scratch_v, btAlignedObjectArray_btMatrix3x3* scratch_m, bool isConstraintPass);
	...
	EXPORT void btMultiBody_getBaseInertia(btMultiBody* obj, btVector3* inertia);
	EXPORT btScalar btMultiBody_getBaseMass(btMultiBody* obj);
	EXPORT const char* btMultiBody_getBaseName(btMultiBody* obj);
	EXPORT void btMultiBody_getBaseOmega(btMultiBody* obj, btVector3* omega);
	EXPORT void btMultiBody_getBasePos(btMultiBody* obj, btVector3* pos);
	EXPORT void btMultiBody_getBaseTorque(btMultiBody* obj, btVector3* value);
	EXPORT void btMultiBody_getBaseVel(btMultiBody* obj, btVector3* vel);
	EXPORT void btMultiBody_getBaseWorldTransform(btMultiBody* obj, btTransform* tr);
	...
	EXPORT void btMultiBody_getWorldToBaseRot(btMultiBody* obj, btQuaternion* rot);

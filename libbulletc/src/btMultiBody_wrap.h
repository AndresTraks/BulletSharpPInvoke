...
extern "C"
{
	...
	EXPORT void btMultiBody_setupPrismatic(btMultiBody* obj, int i, btScalar mass, const btScalar* inertia, int parent, const btScalar* rotParentToThis, const btScalar* jointAxis, const btScalar* parentComToThisComOffset, const btScalar* thisPivotToThisComOffset, bool disableParentCollision);

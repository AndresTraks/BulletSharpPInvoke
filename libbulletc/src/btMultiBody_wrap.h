...
extern "C"
{
	...
	EXPORT void btMultiBody_addJointTorqueMultiDof(btMultiBody* obj, int i, int dof, btScalar Q);
	EXPORT void btMultiBody_addJointTorqueMultiDof2(btMultiBody* obj, int i, const btScalar* Q);
	...
	EXPORT void btMultiBody_stepVelocitiesMultiDof2(btMultiBody* obj, btScalar dt, btAlignedScalarArray* scratch_r, btAlignedVector3Array* scratch_v, btAlignedMatrix3x3Array* scratch_m, bool isConstraintPass);

...
extern "C"
{
	...
	EXPORT btAlignedObjectArray_bParse_bStructHandle* bParse_btBulletFile_getBvhs(bParse_btBulletFile* obj);
	...
	EXPORT btAlignedObjectArray_bParse_bStructHandle* bParse_btBulletFile_getSoftBodies(bParse_btBulletFile* obj);
	EXPORT btAlignedObjectArray_bParse_bStructHandle* bParse_btBulletFile_getTriangleInfoMaps(bParse_btBulletFile* obj);

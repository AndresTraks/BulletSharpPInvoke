...
namespace BulletSharp.SoftBody
{
    ...
    public class AlignedNodeArray : IList<Node>
    {
        ...
        public int Count
        {
            get { return btAlignedObjectArray_btSoftBody_Node_size(_native); }
        }
        ...
        static extern IntPtr btAlignedObjectArray_btSoftBody_Node_at(IntPtr obj, int n);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern int btAlignedObjectArray_btSoftBody_Node_index_of(IntPtr obj, IntPtr val);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern void btAlignedObjectArray_btSoftBody_Node_push_back(IntPtr obj, IntPtr val);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern void btAlignedObjectArray_btSoftBody_Node_resizeNoInitialize(IntPtr obj, int newSize);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern int btAlignedObjectArray_btSoftBody_Node_size(IntPtr obj);
    }
}

...
namespace BulletSharp.SoftBody
{
    ...
    public class AlignedTetraArray : IList<Tetra>
    {
        ...
        public int Count
        {
            get { return btAlignedObjectArray_btSoftBody_Tetra_size(_native); }
        }
        ...
        static extern IntPtr btAlignedObjectArray_btSoftBody_Tetra_at(IntPtr obj, int n);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern void btAlignedObjectArray_btSoftBody_Tetra_push_back(IntPtr obj, IntPtr val);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern void btAlignedObjectArray_btSoftBody_Tetra_resizeNoInitialize(IntPtr obj, int newSize);
        [DllImport(Native.Dll, CallingConvention = Native.Conv), SuppressUnmanagedCodeSecurity]
        static extern int btAlignedObjectArray_btSoftBody_Tetra_size(IntPtr obj);
    }
}

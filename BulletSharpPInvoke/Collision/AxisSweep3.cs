...
namespace BulletSharp
{
	public class AxisSweep3 : BroadphaseInterface
	{
        ...
        public ushort AddHandle(ref Vector3 aabbMin, ref Vector3 aabbMax, IntPtr owner,
        ...
        */
        ...
        void UnQuantize(BroadphaseProxy proxy, out Vector3 aabbMin, out Vector3 aabbMax)
		{
			btAxisSweep3_unQuantize(_native, proxy._native, out aabbMin, out aabbMax);
		}

		public void UpdateHandle(ushort handle, Vector3 aabbMin, Vector3 aabbMax, Dispatcher dispatcher)
		{
	...
	public class AxisSweep3_32Bit : BroadphaseInterface
	{
        ...
        public uint AddHandle(ref Vector3 aabbMin, ref Vector3 aabbMax, IntPtr owner,
            short collisionFilterGroup, short collisionFilterMask, Dispatcher dispatcher,
            IntPtr multiSapProxy)
		{
